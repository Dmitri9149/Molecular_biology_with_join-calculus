...
let standard_library_default = "/usr/local/lib/jocaml"
let _ocaml_library = "/usr/local/lib/ocaml"
let ocaml_library = match _ocaml_library with
| "" -> None
| s  -> Some s
...
let standard_runtime = "/usr/local/bin/jocamlrun"
let ccomp_type = "cc"
